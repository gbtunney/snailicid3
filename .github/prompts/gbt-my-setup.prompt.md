...
_Keep this checklist up to date with only actionable, current setup steps. Remove or update any
items that become obsolete._
...
- For shell scripts, you can also save the block to a file (e.g., `setup.sh`), then run
