...
This document defines the conversational, AI-guided interview process used to produce
field,object,data specs that conform to the general described spec structure. It is not a rigid CLI,
schema, or form. It is a human-first interview with suggested options and defaults.
...
After an interview completes for design notes (by request), AI should reconstruct an interview
