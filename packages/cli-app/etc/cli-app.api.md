...
export const appConfigSchema: z.ZodObject<
  {
    ...
    flag_aliases: z.ZodPipe<
      z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodString>>,
      z.ZodTransform<
        {
          help?: string
          version?: string
...
// @public
export const initApp: <AppOptionsSchema extends ZodObjectSchema>(
...
// @public (undocumented)
export const initializeApp: <AppOptionsSchema extends ZodObjectSchema>(
  optionsSchema: AppOptionsSchema,
  config: AppConfigIn,
  initFunction: InitSuccessCallback<AppOptionsSchema>,
  skip_interactive?: boolean,
