...
export type CompactSerializedJsonString<Type extends JsonValue = JsonValue> =
...
export type PrettySerializedJsonString<Type extends JsonValue = JsonValue> =
 ...
 *
 * The phantom `__jsonValue` field lets the string remember the value type it represents without affecting runtime
 * output.
 */
...
type JsonifyArray<Type extends ReadonlyArray<unknown>> =
...
type NonOmittedJsonObjectValue<Type> = Exclude<Type, JsonOmittedObjectValue>
