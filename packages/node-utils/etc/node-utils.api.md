...
const node: {
  ...
  fsPathArray: (
    root?: string,
    getDirectoryFileContents?: boolean,
  ) => z.ZodType<Array<filePath_3.FilePath>, string>
  fsPathExists: (
    exists?: boolean,
    root?: string,
    allowedType?:
      | 'any'
      | (Array<Exclude<filePath_3.FileType, undefined>> | Exclude<filePath_3.FileType, undefined>),
  ) => ReturnType<typeof zod_fs_schema.fsPathTypeExists>
  fsPathTypeExists: (
    allowedType?:
      | 'any'
      | 'none'
  ...
  getYArgs: <Type extends z.ZodObject>(
    schema: Type,
    debug?: boolean,
    _yargs?: string[],
