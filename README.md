...
| [`@snailicid3/build-config`](./packages/build-config)       | Rollup, vite, vitest and typedoc build tool configs                    |
...
| [`@snailicid3/zod-helpers`](./packages/zod-helpers)         | Reusable Zod schemas and schema patterns                               |
...
| [`@snailicid3/workspace-tools`](./packages/workspace-tools) | Workspace introspection and repo tooling                               |
