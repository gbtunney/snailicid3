...
**Manifest snapshot (`packages/config/package.json`):**
...
```json
{
  ...
  "version": "0.0.0",
  "private": false,
  "description": "Shared linting, formatting, and TypeScript config utilities for the snailicid3 monorepo",
  "scripts": {
    "build:ts:nx": "nx run $npm_package_name:build:ts",
  ...
  "files": ["CHANGELOG.md", "dist", "tsconfig-base.json"],
  "keywords": ["eslint", "prettier", "typescript", "config"],
  "nx": {
    "targets": {
      "build:ts": {},
      "build": {
